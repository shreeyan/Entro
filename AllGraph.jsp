  		                        ...
  		                        <div class="col-sm-10">
               						<div class="row">
                                  		<% 
                                        	...
                                        	Product pc1=(Product)abstractDao.getById("id",4, Product.class);                                        
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body" style="display: flex; justify-content: center; align-items: center;">
                                          ...
                                          <center><img src="SentimentChart?productId=3" width="360" height="250"></center></p>
                                        </div>
                                     ...
                                     <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body" style="display: flex; justify-content: center; align-items: center;">
                                          ...
                                          <b>  Features  : </b><%=pc1.getFeatures() %>
                                             <center><img src="SentimentChart?productId=4" width="360" height="250"></center></p>
                                      </p>
                                        </div>
