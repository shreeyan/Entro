...
<head>
    ...
    <title> Entro | Feature wise analytical graph</title>
    ...
    <div id="wrapper">
       <% if(user.getUserType().equals("admin")) {%>
        ...
        <div id="page-wrapper">
			...
			<h1>Quality Assuring Analytical graph</h1>
			<p>show you the quality of facilities in there company.</p>
			
		</section>
                            <div class="panel-body">
  		                        <div class="row">
  		                        <center>	<img src="FeatureChart?productId=<%=request.getParameter("productId").toString()%>"></center>
                            	</div>
                    		</div> 
